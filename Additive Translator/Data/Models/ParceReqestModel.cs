using Additive_Translator.Data.Enums;

namespace Additive_Translator.Data.Models
{
    public class ParceReqestModel
    {
        public RobotTargetEnum TargetRobot { get; set; } = RobotTargetEnum.Fanuc;
        //File settings
        public string InputFilePath { get; set; }
        public string OutputFile { get; set; }

        public string EditConfig { get; set; } //Additional Config String
        public string EditUnit { get; set; } // Система измерения скорости (def cm/min)
